...
class BasisMomentum6(BaseCarryFactor):
    """
    ...
    用于TS1（近月、次近月）、TS3（近月、远月）因子连续合约化，在连续合约上进行回溯，区别于 BasisMomentum2 在当日合约pair上进行回溯
...
if __name__ == "__main__":
    self = BasisMomentum6(price='close', R=120,others='far')
