...
class MomentumFactor1(BaseMomentumFactor):
    ...
    def __init__(self,
                 dm=None,
                 R: int = 5, contract: str = 'main', price: str = 'close', rebalance_days: int = 1) -> None:
        """
        Constructor
        ...
        rebalance_days: int, default 1
                    选择几日换仓, 1 or 3 or 5
        """
        super().__init__(dm=dm, R=R, contract=contract, price=price, rebalance_days=rebalance_days)
